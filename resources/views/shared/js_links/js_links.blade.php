...
<!-- Custom JS -->
<script src="{{ asset('public/js/my_js/CashAdvance.js?n=454354') }}"></script>
<script src="{{ asset('public/js/my_js/UserApprover.js?n=1') }}"></script>
<script src="{{ asset('public/js/my_js/NumberToWord.js?n=1') }}"></script>